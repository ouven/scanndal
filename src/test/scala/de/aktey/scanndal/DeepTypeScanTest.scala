...
import de.aktey.scanndal.deeptypescantest.{AnInterface, SuperSuperClass, AnOtherInterface}
 ...
 * Time: 07:23
 */
class DeepTypeScanTest extends Specification {
